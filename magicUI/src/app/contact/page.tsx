...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:support@vectorcraft.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground">
                  <a href="mailto:support@vectorcraft.com" className="hover:text-primary">
                    support@vectorcraft.com
                  </a>
                </p>
